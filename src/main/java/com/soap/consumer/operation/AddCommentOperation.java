...
public class AddCommentOperation extends SoapOperationImpl {
	...
	/**
	 * Control of the params needed in the Soap Request.
	 * <crs:Credentials>
            <!--Optional:-->
	...
	public Object createRequest() {
		...
		localizer.setAgentLocalizator(params.get(SoapOperationProperties.AGENT_LOCALIZATOR_PARAM_LABEL));
		localizer.setBookingCode(params.get(SoapOperationProperties.BOOKING_CODE_PARAM_LABEL));
		localizer.setLocalizator(params.get(SoapOperationProperties.LOCALIZATOR_PARAM_LABEL));
