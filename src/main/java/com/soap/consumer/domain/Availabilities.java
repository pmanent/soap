...
/**
 * <p>Clase Java para Availabilities complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AvailabilityPeriod" type="{ws.avantio.com/crsConnectionServices}AvailabilityPeriod" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Availabilities", propOrder = {
    "availabilityPeriod"
})
public class Availabilities {

    @XmlElement(name = "AvailabilityPeriod", required = true)
