...
/**
 * <p>Clase Java para GetAllAccommodationListRQ complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GetAllAccommodationListRQ"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetAllAccommodationListRQ", propOrder = {
    "credentials"
})
public class GetAllAccommodationListRQ {
