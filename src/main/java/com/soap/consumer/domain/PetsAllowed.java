...
/**
 * <p>Clase Java para PetsAllowed complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PetsAllowed"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LimitWeight" type="{http://www.w3.org/2001/XMLSchema}positiveInteger"/&gt;
...
@XmlType(name = "PetsAllowed", propOrder = {
    "allowed",
    "includedInPrice",
    "limitWeight",
    "additionalPrice",
...
public class PetsAllowed {
    ...
    @XmlElement(name = "LimitWeight", required = true)
